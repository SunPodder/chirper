...
<form action="/" class="max-w-[580px] {className}">
    <div class="flex">
        ...
        <div class="w-full">
            <textarea autofocus="true" id="message" rows="2" class="block p-2.5 w-full text-sm rounded-lg bg-transparent focus:outline-none" placeholder="Write your thoughts here..."></textarea>
